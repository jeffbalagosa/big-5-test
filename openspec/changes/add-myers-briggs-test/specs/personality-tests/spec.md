...
This capability defines the supported personality assessment frameworks and their behaviors.
...
- **THEN** a PDF is generated with:
  ...
  - A bar graph showing dichotomy preferences
  - Author name if provided via `--author`

#### Scenario: MBTI visualization format

- **WHEN** the MBTI bar graph is generated
- **THEN** it displays four horizontal bars, one per dichotomy, showing preference direction and percentage
